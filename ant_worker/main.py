...
from SQS_Processer import sqs_Message_Consumer
...
ANT_Service_Context_Default_schema = {
    "type": "object",
    "properties": { 
        "networkType": {"type": "string"}, "antServiceContextName": {"type": "string"}, "CPEType": {"type": "string"},
        "antModel": {"type": "string"}, "platformType": {"type": "string"}, "antVendor": {"type": "string"},
        "refNodeSegmentName": {"type": "string"}, "antServiceContextId":{"type": "string"}
    },      
    "required": [
        "networkType", 
